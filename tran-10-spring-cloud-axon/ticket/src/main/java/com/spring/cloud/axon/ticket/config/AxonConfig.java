package com.spring.cloud.axon.ticket.config;
...
public class AxonConfig {
    ...
    public Binding ticketQueueBinding() {
        return BindingBuilder.bind(ticketQueue()).to(exchange()).with("com.spring.cloud.axon.ticket.event.#").noargs();
    }
    ...
    public Binding ticketSagaQueueBinding() {
        return BindingBuilder.bind(ticketSagaQueue()).to(exchange()).with("com.spring.cloud.axon.ticket.event.saga.#").noargs();
    }
